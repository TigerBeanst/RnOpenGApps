...
public class GetLatest90 {
    static Handler handler;
    public static int GetLatest90(final Context context, final View view, final SharedPreferences data_of_download) {
        /**
         * 获取最新下载地址
         *
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    Log.d("debug", "用URL连接P");
                    URL url = new URL("https://builds.nezorfla.me/?dir=opengapps/pie/" + cpu_what );
                    ...
                    apiData = response.toString(); //页面内容
                    Log.d("debug", "转化为字符串");
                    int loc = apiData.indexOf("aroma-"); //获取日期位置
                    loc++;
                    String version = apiData.substring(loc+5,loc+13);
